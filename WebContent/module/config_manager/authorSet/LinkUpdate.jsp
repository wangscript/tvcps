...
<form action="author.do"  method="post" name="generalSystemSetForm" id="generalSystemSetForm" >
	...
	<table style="width:770px;; font:12px;" >
		...
		<tr>
	    	<td class="td_left" width="90px;"> 
            	<i>*</i>热链地址：</td><td>
			    <input type="text" name="generalSystemSet.url" id="url" class="input_text_normal"   style="width:230px;"  value="${generalSystemSetForm.generalSystemSet.url}"  valid="string" tip="非本地热链地址需http://开头"  />
            </td>
	     	<td></td>
		</tr>
		<tr>
