...
<script type="text/javascript">
	...
	function button_add_onclick() {
		var categoryId = $("#categoryId").val();
		win = showWindow("onlineSurvey", "添加一般调查", "onlineSurvey.do?dealMethod=onlinedetail&categoryId="+categoryId, 0, 0, 550, 350);
	}
	...
	function orgdetail(id) {
		...
		win = showWindow("onlineSurveyForm", "修改一般调查", url,  0, 0, 550, 350);
	}
...
<form id="onlineSurveyForm" action="<c:url value='/onlineSurvey.do'/>"method="post" name="onlineSurveyForm">
	...
	<div class="currLocation">功能单元→ 网上调查→一般调查  </div>
	<complat:button buttonlist="add|0|delete" buttonalign="left" /> 
	<complat:grid  ids="xx" 
		width="200,120,120,200,100"
		head="调查主题,创建人,类别,创建时间,网上调查问题"
