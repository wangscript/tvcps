...
<script>
	...
	function button_sure_onclick(ee) {
		...
		$.ajax({
				url : '<c:url value="/titleLinkPage.do?dealMethod=findFieldCode&nodeId="/>'+ nodeId + "&contextFrom="+ type,
				type: "post",
...
<body>
<form action="<c:url value="/titleLinkPage.do"/>" id="titleLinkPageForm" name="titleLinkPageForm" >
