		...
		<table width="100%" height="60" border="0" cellspacing="0"
			...
			<tr>
				...
				<td><iframe frameborder="0" id="topFrame" name="topFrame" scrolling="no"
					style="height: 60px; visibility: inherit; width: 100%; z-index: 3"
				...
				<tr>
					<c:forEach var="menu" items="${menuList}">
						<c:if test="${menu.id != 'm010'}">
							<td align="center" width="95"><a id="${menu.id}"  onFocus="this.blur()" href="javascript:loadIndex('${menu.id}','${menu.name}','${menu.indexPage}','${menu.contentPage}')">${menu.name}</a></td>
						</c:if>
					<c:if test="${menu.id == 'm010'}">
					...
					<td align="right">
						<table width="120" height="18" border="0" cellpadding="0" cellspacing="0">
					      <tr>
					        ...
					        <td align="center" valign="bottom" style="cursor:pointer;" onclick="help();">关于</td>
					        ...
					        <td align="center" valign="bottom" style="cursor:pointer;" onclick="logout();">退出</td>
					      </tr>
					    </table>
					</td>
				</tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" style="height:100%;">
				<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0"
						style="height: 100%">
						<tr>
							<td bgcolor="#f5f9ff" style="height: 100%"><img
								style="cursor: pointer;"
								src="/${appName}/images/main/nav_porinter_open_out.gif"
								onmouseout="changeImgBg(this, 'out');"
								onmouseover="changeImgBg(this, 'over');"
								onclick="switchSysBar(this);"/>
							</td>
						</tr>
					</table>
					</td>
					<td style="width:100%;border:1px;"><iframe frameborder="0" id="rightFrame"
