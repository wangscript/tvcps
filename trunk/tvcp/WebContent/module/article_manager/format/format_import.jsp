	...
	$(document).ready(function() {
		...
		if(message != null && message != "" && message != "null"){
			if(message == "导入成功") {
				...
				rightFrame.window.location.href="<c:url value='/articleFormat.do?dealMethod='/>";
			} else {
				alert(message);
				closeWindow(rightFrame.getWin());
			}
...
<body>
<form action="<c:url value="/articleFormat.do"/>" enctype="multipart/form-data" method="post" name="articleFormatForm">
	...
	<div class="form_div">
		<table style="font:12px; width:440px;">
			...
			<tr>
				<td class="td_left" width="80px;">□</td>
				<td width="280px;"> 导入格式(文件名后缀： .xml)</td>
			</tr>
			<tr>
				<td class="td_left" width="80px;">□</td>
