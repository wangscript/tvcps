...
<script>
	...
	function button_sure_onclick(ee) {
		...
		$.ajax({
				url : '<c:url value="/pictureNews.do?dealMethod=findFieldCode&nodeId="/>'+ nodeId + "&contextFrom="+ type,
				type: "post",
...
<body>
<form action="<c:url value="/pictureNews.do"/>" id="pictureNewsForm" name="pictureNewsForm" >
