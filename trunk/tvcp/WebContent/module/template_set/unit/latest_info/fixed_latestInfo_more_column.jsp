...
<script>
	...
	function button_sure_onclick(ee) {
		...
		secondTempWindow.document.getElementById("chooseMoreColumnExample").value = $("#checkname").val(); 
		secondTempWindow.document.getElementById("moreLinkColumn").value = $("#checkid").val() + "##" + $("#checkname").val();	
