...
$.blockUI.defaults = {
    ...
    message:  '<font style="font-size:12px;font-family:Arial, Helvetica, sans-serif,"宋体";background-color:#fff;">加载中.请稍后......</font>',
...
function bind(b, el, opts) {
    ...
    var events = 'mousedown mouseup keydown keypress click onclick';
