...
$.funkyUI   = function(opts) { var oo = install(a, opts); return oo;};
...
//    var full = (el == window.top);
	...
	topWin.$.DialogData.cw = a.document.compatMode == "BackCompat" ?a.document.body.clientWidth:a.document.documentElement.clientWidth;//窗体高度
	topWin.$.DialogData.ch = a.document.compatMode == "BackCompat" ?a.document.body.clientHeight:a.document.documentElement.clientHeight;//窗体宽度//必须考虑文本框处于页面边缘处，控件显示不全的问题
	topWin.$.DialogData.sw = Math.max(a.document.documentElement.scrollLeft, a.document.body.scrollLeft);//横向滚动条位置
	topWin.$.DialogData.sh = Math.max(a.document.documentElement.scrollTop, a.document.body.scrollTop);//纵向滚动条位置//考虑滚动的情况
...
//	}
    ...
    var arr = [];
		if(opts.showDialog){
			...
			arr.push("    <td width='13' height='33' style=\"background-image:url(/"+app+"/images/dialog/dialog_lt.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/"+app+"/images/dialog/dialog_lt.png', sizingMethod='crop');\"><div style='width:13px;'></div></td>");
			arr.push("    <td height='33' style=\"background-image:url(/"+app+"/images/dialog/dialog_ct.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/"+app+"/images/dialog/dialog_ct.png', sizingMethod='crop');\"><div style=\"float:left;font-weight:bold; color:#FFFFFF; padding:9px 0 0 4px;\"><img src=\"/"+app+"/images/dialog/icon_dialog.gif\" align=\"absmiddle\">&nbsp;<span id='imgFileTitle'>"+opts.title+"</span></div>");
			arr.push("      <div style=\"position: relative;cursor:pointer; float:right; margin:5px 0 0; _margin:4px 0 0;height:17px; width:28px; background-image:url(/"+app+"/images/dialog/dialog_closebtn.gif)\" onMouseOver=\"this.style.backgroundImage='url(/"+app+"/images/dialog/dialog_closebtn_over.gif)'\" onMouseOut=\"this.style.backgroundImage='url(/"+app+"/images/dialog/dialog_closebtn.gif)'\" drag='false' onClick=\"$.unfunkyUI('"+opts.id+"','"+opts.fadeOut+"');\"></div></td>");
			arr.push("    <td width='13' height='33' style=\"background-image:url(/"+app+"/images/dialog/dialog_rt.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/"+app+"/images/dialog/dialog_rt.png', sizingMethod='crop');\"><div style=\"width:13px;\"></div></td>");
			arr.push("  </tr>");
			arr.push("  <tr drag='false'><td width='13' style=\"background-image:url(/"+app+"/images/dialog/dialog_mlm.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/"+app+"/images/dialog/dialog_mlm.png', sizingMethod='crop');\"></td>");
			...
			arr.push("          <td height='50' valign='top'><table id='_MessageTable_"+opts.id+"' width='100%' border='0' cellspacing='0' cellpadding='8' style=\" background:#EAECE9 url(/"+app+"/images/dialog/dialog_bg.jpg) no-repeat right top;\">");
			arr.push("              <tr><td width='25' height='50' align='right'><img id='_MessageIcon_"+opts.id+"' src='/"+app+"/images/dialog/window.gif' width='32' height='32'></td>");
			...
			arr.push("          <iframe src='");	
			arr.push(url);
			arr.push("' id='_DialogFrame_"+opts.id+"' allowTransparency='true'  width='"+css.width+"' height='"+css.height+"' frameborder='0' style=\"background-color: #transparent; border:none;visibility:inherit;\" filter=\'progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)\';></iframe></td></tr>");
		...
		//	arr.push("            </td></tr>");
			arr.push("      </table></td>");
			arr.push("    <td width='13' style=\"background-image:url(/"+app+"/images/dialog/dialog_mrm.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/"+app+"/images/dialog/dialog_mrm.png', sizingMethod='crop');\"></td></tr>");
			arr.push("  <tr><td width='13' height='13' style=\"background-image:url(/"+app+"/images/dialog/dialog_lb.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/"+app+"/images/dialog/dialog_lb.png', sizingMethod='crop');\"></td>");
			arr.push("    <td style=\"background-image:url(/"+app+"/images/dialog/dialog_cb.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/"+app+"/images/dialog/dialog_cb.png', sizingMethod='crop');\"></td>");
			arr.push("    <td width='13' height='13' style=\"background-image:url(/"+app+"/images/dialog/dialog_rb.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/"+app+"/images/dialog/dialog_rb.png', sizingMethod='crop');\"></td>");
			arr.push("  </tr></table>");
		}else{
		...
		if(!lyr2.length>0){			
		//	lyr2 = full ? $('<div class="funkyUI blockOverlay"  style="z-index:'+ z++ +';cursor:wait;opacity:0;position:absolute;border:none;margin:0;padding:0;filter:alpha(opacity=0);width:'+topWin.$.DialogData.cw+'px;height:'+topWin.$.DialogData.ch+'px;"><iframe src="javascript:false" style="position:absolute; visibility:inherit; width:'+topWin.$.DialogData.cw+'px;height:'+topWin.$.DialogData.ch+'px; z-index:-1; filter=\'progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)\';"></iframe></div>', topWin.document.body):$('<div class="funkyUI blockOverlay" style="z-index:'+ z++ +';cursor:wait;border:none;margin:0;padding:0;width:100%;height:100%;top:'+css.top+';left:'+css.left+'"><iframe src="javascript:false" style="position:absolute; visibility:inherit; top:0px; left:0px; width:500px; height:420px; z-index:-1; filter=\'progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)\';"></iframe></div>');
			var tempwidth = top.document.body.offsetWidth;
			var tempheight = top.document.body.offsetHeight;	 
			if(tempwidth < top.document.body.scrollWidth){
				tempwidth = top.document.body.scrollWidth;
			}
			if(tempheight < top.document.body.scrollHeight){
				tempheight =  top.document.body.scrollHeight;
			}
			lyr2 = full ? $('<div class="funkyUI blockOverlay"  style="z-index:'+ z++ +';cursor:wait;opacity:0;position:absolute;border:none;margin:0;padding:0;filter:alpha(opacity=0);width:'+tempwidth+'px;height:'+tempheight+'px;top:0;left:0"><iframe src="javascript:false" style="position:absolute; visibility:inherit; width:'+top.document.body.offsetWidth+'px;height:'+top.document.body.offsetHeight+'px; top:0;left:0; z-index:-1; filter=\'progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)\';"></iframe></div>', topWin.document.body):$('<div class="funkyUI blockOverlay" style="z-index:'+ z++ +';cursor:wait;border:none;margin:0;padding:0;width:100%;height:100%;top:'+css.top+';left:'+css.left+'"><iframe src="javascript:false" style="position:absolute; visibility:inherit; top:0px; left:0px; width:500px; height:420px; z-index:-1; filter=\'progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)\';"></iframe></div>');
		...
		if(!lyr3.length>0){
		//	alert("22222222222");
		//	lyr3 = full ? $('<div class="funkyUI blockMsg blockPage" style="z-index:'+ z +';position:absolute;left:'+css.left+'px;top:'+css.top+'px"></div>',topWin.document.body)
	     //               : $('<div class="funkyUI blockMsg blockElement" style="z-index:'+ z +';display:none;position:absolute;left:'+css.left+'px;top:'+css.top+'px">'+opts.message+'</div>');
		//	alert("css.left===="+css.left);
		//	alert("css.top===="+css.top);
			lyr3 = $('<div class="funkyUI blockMsg blockPage" style="z-index:'+ z +';position:absolute;left:'+css.left+'px;top:'+css.top+'px"></div>',topWin.document.body);
			lyr3.hide();
    ...
    if(full){
		...
		//	alert(css.top);
			if(css.top > 0){
				...
				lyr3.css({left:css.left+"px",top:"20px",width:css.width+"px",height:css.height+"px"});
			}
			if(opts.showDialog){
				//记录当前弹出窗口的iframe对象
...
function bind2(b, el, id) {
    ...
    var events = 'mousedown mouseup keypress keydown click';
    var doc = full ? $(el.document):$(document);
 //   b ? doc.bind2(events, {opts:id,el:el}, handler) : doc.unbind(events, handler);
...
$.unfunkyUI = function(optsid,fadeOut) {
	var frameId = '_DialogFrame_' + optsid;
	if (document.getElementById(frameId)) {
		// 回调程序员自己的函数 win_close
		var funWinClose = document.getElementById(frameId).contentWindow.win_close;
		if (typeof(funWinClose) == "function") {
			funWinClose(optsid);
		}
	}
	remove2(a, optsid,fadeOut); 
};


function remove2(el, optsid,fadeOut) {
    var full = el == a;
 // opts = $.extend({}, $.funkyUI.defaults, opts || {});
    if (full) {		
    	if(topWin.$._Array.length>1){
    		var win = topWin.$._Array.pop();
    		topWin.$.DialogData.backgroundDiv.css('z-index',parseInt(topWin.$._Array[topWin.$._Array.length-1].$.DialogData.dialogDiv.css('z-index'))-1);	
			$('#_DialogDiv_'+optsid).fadeOut("normal");
    		bind2(0, el, optsid); // unbind events
    	}else{
    		var win = topWin.$._Array.pop();
			$('#_DialogDiv_'+optsid).fadeOut("normal");
    		bind2(0, el, optsid); // unbind events
