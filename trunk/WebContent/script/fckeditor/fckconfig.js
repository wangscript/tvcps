...
FCKConfig.Plugins.Add( 'filemanager','zh-cn' );
...
FCKConfig.TabSpaces		= 1 ;      //在编辑器域内可以使用Tab键
...
FCKConfig.ToolbarSets["Gov_open"] = [
	['Source','-','Preview'],
	['Undo','Redo','-','Find','Replace','-','PasteText','PasteWord','RemoveFormat'],
 ...
 * 只包含基本字体样式的工具栏
 */
FCKConfig.ToolbarSets["Gov_font"] = [
 ...
 * 包含字体样式、插入图片、编辑命令
 */
FCKConfig.ToolbarSets["Gov_picfont"] = [
	['Source','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','About'],
	['TextColor','BGColor','FontName','FontSize'],
	['Undo','Redo','-','Find','Replace','-','PasteText','PasteWord','RemoveFormat'],
...
FCKConfig.FontNames		= '仿宋_UTF-8;黑体;楷体_UTF-8;隶书;宋体;新宋体;幼圆;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana;方正舒体;方正姚体;华文彩云;华文细黑;华文新魏;华文行楷;华文中宋' ;
