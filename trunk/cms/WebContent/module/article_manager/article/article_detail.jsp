...
<form id="articleForm" name="articleForm" action="<c:url value="/article.do"/>" method="post">
	...
	<input type="hidden" name="auditorId" id="auditorId" value="${articleForm.auditorId }"/> 
		...
		<ul>
	<input type="hidden" name="article.deleted" id="article.deleted"
		value="false" />
	<input type="hidden" name="article.audited" id="articleaudited"
		value="false" />
	<input type="hidden" name="article.publishState" id="articlepublished"
		value="0" />
	...
	<table width="900" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td valign="middle"><input name="article.title" type="text"
				class="input_text_normal" tip="标题不能为空" valid="string"
				id="articleTitle" style="width: 747px" empty="false" value="${articleForm.article.title}" /></td>
		</tr>
		<tr>
			<td class="td_left">副标题：</td>
			<td valign="middle"><input name="article.subtitle" type="text"
				class="input_text_normal" id="subtitle" style="width: 747px"
				empty="true" valid="string" value="${articleForm.article.subtitle}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td valign="middle"><input name="article.infoSource" type="text"
				id="infoSource" class="input_text_normal" style="width: 250px"
				empty="true" valid="string"  value="${articleForm.article.infoSource}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select
				name="generalSystemSetOrgin" id="yy" style="width: 155px;"
				class="input_select_normal" onchange="changeValueOrgin(this)"></select>
			</td>
		</tr>
		<tr>
			<td class="td_left">作者：</td>
			<td valign="middle" width="600px"><input name="article.author"
				type="text" id="author" class="input_text_normal"
				style="width: 250px;" empty="true" valid="string"   value="${articleForm.article.author}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select
				name="generalSystemSetHtml" id="generalSystemSetHtml"
				style="width: 155px;" class="input_select_normal"
				onchange="changeValueSelect(this)"></select></td>
		</tr>
		<tr>
			<td class="td_left">内容：</td>
			<td><textarea name="article.textArea" id="textArea"
				class="input_textarea_normal" cols="98" rows="10"> ${articleForm.article.textArea}</textarea></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td valign="middle"><input name="article.pic" type="text"
				class="input_text_normal" id="article.pic" style="width: 470px"
				readonly  value="${articleForm.article.pic}"  /> &nbsp;&nbsp;<input name="button" type="button"
				value="上传" class="btn_samll" onclick="uploadPicture('article.pic')" />
			&nbsp;&nbsp;<input name="button2" type="button" value="清空"
				class="btn_samll" onclick="clearPic('article.pic1')" /></td>
		</tr>
		<tr>
			<td class="td_left">附件：</td>
			<td valign="middle"><input name="article.attach" type="text"
				class="input_text_normal" id="article.attach" readonly
				style="width: 470px"   value="${articleForm.article.attach}"  /> &nbsp;&nbsp;<input name="button"
				type="button" value="上传" class="btn_samll"
				onclick="uploadAtta('article.attach')" /> &nbsp;&nbsp;<input
				name="button2" type="button" class="btn_samll"
				onclick="clearAtta('article.attach')" value="清空" /></td>
		</tr>
		<tr>
			<td class="td_left">媒体：</td>
			<td valign="middle"><input name="article.media" type="text"
				class="input_text_normal" id="article.media" readonly
				style="width: 470px"  value="${articleForm.article.media}"  /> &nbsp;&nbsp;<input name="button"
				type="button" value="上传" class="btn_samll"
				onclick="uploadFlash('article.media')" /> &nbsp;&nbsp;<input
				name="button2" type="button" onclick="clearFlash('article.media')"
				class="btn_samll" value="清空" /></td>
		</tr>
		<tr>
			<td class="td_left">
			显示时间：</td>
			<td> <input type="text" empty="true" name="article.displayTime"
				id="article.displayTime" class="Wdate" style="width: 140px"
