	...
	*/
	...
	function TArticle(columnName, columnLink, title, url, author, hits,displaytime, publishtime,toped) {	
	...
	function TgetArticles(articleUrl, flag) {
		...
		//	var createTime = articles[i].getElementsByTagName("createTime")[0].firstChild.nodeValue;
			...
			var article = new TArticle(columnName,columnLink,articletitle,articleurl,articleauthor,articlehits,displayTime,publishTime, toped);
