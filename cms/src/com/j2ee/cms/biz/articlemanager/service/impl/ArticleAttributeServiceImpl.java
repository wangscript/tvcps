...
import com.j2ee.cms.biz.articlemanager.service.ArticleAttributeService;
...
public class ArticleAttributeServiceImpl implements ArticleAttributeService {
	...
	public String addAttribute(ArticleAttribute attribute, String siteId, String sessionID) {
		...
		if(list == null  || list.size() == 0) {
			...
			String fieldsStr = "";
			if(format.getFields() != null && !format.getFields().equals("")){
				fieldsStr = format.getFields() + "," ;
			}
			
			// 2.更新格式中字段集合
			String fields = fieldsStr + attribute.getFieldName();
			...
			BeanUtil.setFieldValue(format, 
					"com.j2ee.cms.biz.articlemanager.domain.ArticleFormat", 
