...
import com.j2ee.cms.biz.articlemanager.dao.ArticleExpandDao;
...
import com.j2ee.cms.biz.articlemanager.domain.ArticleExpand;
...
public class ArticleFormatServiceImpl implements ArticleFormatService {
	 ...
	 * 文章表扩展字段dao
	 */
	private ArticleExpandDao articleExpandDao;
	...
	public String addFormat(ArticleFormat format, String siteId, String sessionID) {
		...
		if(CollectionUtil.isEmpty(list)) {
			...
			articleExpand.setId(StringUtil.UUID());
			articleExpand.setArticleFormat(format);
			articleExpandDao.save(articleExpand);
			// 设置缓存状态
...
//				public String addFormat(ArticleFormat format, String siteId, String sessionID)
	...
	/**
	 * @param articleExpandDao the articleExpandDao to set
	 */
	public void setArticleExpandDao(ArticleExpandDao articleExpandDao) {
		this.articleExpandDao = articleExpandDao;
	}
}
