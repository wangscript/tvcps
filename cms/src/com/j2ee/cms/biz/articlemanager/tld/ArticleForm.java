	...
	public void buildDefaultArticleHtmlTag(StringBuffer sb, String appName) {
		...
		if(article != null) {
			if (article != null && article.getId() != null ) {
				...
				textArea = StringUtil.convert((String) getArticleFieldValue("textArea"));
				...
				pic = StringUtil.convert((String) getArticleFieldValue("pic"));
				attach = StringUtil.convert((String) getArticleFieldValue("attach"));
				media = StringUtil.convert((String) getArticleFieldValue("media"));
		...
		sb.append("    <td>");
		sb.append("      <textarea name=\"article.textArea\" id=\"textArea\"  class=\"input_textarea_normal\"  cols=\"98\" rows=\"10\">"+ textArea +"</textarea>");
		sb.append("   </td>");
		sb.append("  </tr>");
		sb.append("  <tr>");
		...
		sb.append("    <td valign=\"middle\">");
		sb.append("	    <input name=\"article.pic\" type=\"text\"   class=\"input_text_normal\"  id=\"article.pic\" style=\"width:470px\" readonly value=\""+ pic +"\"/>");
		sb.append("     &nbsp;&nbsp;<input name=\"button\" type=\"button\" value=\"上传\" class=\"btn_samll\" onclick=\"uploadPicture('article.pic')\"/>");
		sb.append("	    &nbsp;&nbsp;<input name=\"button2\" type=\"button\" value=\"清空\" class=\"btn_samll\"  onclick=\"clearPic('article.pic')\"/>");
		sb.append("    </td>");
		sb.append("  </tr>");
		sb.append("  <tr>");
		sb.append("    <td class=\"td_left\">附件：</td>");
		sb.append("    <td valign=\"middle\">");
		sb.append("        <input name=\"article.attach\" type=\"text\"   class=\"input_text_normal\"  id=\"article.attach\" readonly style=\"width:470px\" value=\""+ attach +"\"/>");
		sb.append("		&nbsp;&nbsp;<input name=\"button\" type=\"button\"  value=\"上传\" class=\"btn_samll\"  onclick=\"uploadAtta('article.attach')\"/>");
		sb.append("		&nbsp;&nbsp;<input name=\"button2\" type=\"button\"  class=\"btn_samll\"  onclick=\"clearAtta('article.attach')\" value=\"清空\" />");
		sb.append("    </td>");
		sb.append("  </tr>");
		sb.append("  <tr>");
		sb.append("    <td class=\"td_left\">媒体：</td>");
		sb.append("    <td valign=\"middle\">");
		sb.append("      <input name=\"article.media\" type=\"text\"  class=\"input_text_normal\"   id=\"article.media\" readonly style=\"width:470px\" value=\""+ media +"\"/>");
		sb.append("		&nbsp;&nbsp;<input name=\"button\" type=\"button\"  value=\"上传\" class=\"btn_samll\"  onclick=\"uploadFlash('article.media')\"/>");
		sb.append("		&nbsp;&nbsp;<input name=\"button2\" type=\"button\" onclick=\"clearFlash('article.media')\" class=\"btn_samll\"  value=\"清空\" />");
		sb.append("    </td>");
		sb.append("  </tr>");
		sb.append("  <tr>");
	...
	private String getDefaultFrontAttribute(ArticleAttribute attribute, String appName) {
		...
		String attributeType = attribute.getAttributeType();
			...
			if(fieldName.equals("title")) {
				...
				if(isShowed) {
					textArea = "<tr><td class=\"td_left\">内容：</td>" +
					"<td valign=\"middle\">	" +
					"<textarea name=\"article.textArea\" id=\"textArea\" class=\"input_textarea_normal\" cols=\"98\" rows=\"10\">"+ fieldValue +"</textarea>"+
					"</td></tr>";
				} else {
					textArea = "<input name=\"article.textArea\" type=\"hidden\" id=\"textArea\" style=\"width:747px\" value=\""+ fieldValue +"\"/>";
				}	
				sb.append(textArea);
			...
			} else if(fieldName.equals("pic")) {
				if(isShowed) {
					pic = "<tr><td class=\"td_left\">图片：</td>" +
					"<td valign=\"middle\">	" +
					"<input name=\"article.pic\" type=\"text\" id=\"pic\" class=\"input_text_normal\" style=\"width:470px\"  readOnly  value=\""+ fieldValue +"\"/>"+
					"&nbsp;&nbsp;<input name=\"button\" type=\"button\" value=\"上传\" class=\"btn_small\" onclick=\"uploadPicture('article.pic')\"/>"+
					"&nbsp;&nbsp;<input name=\"button2\" type=\"button\" value=\"清空\" class=\"btn_small\"  onclick=\"clearPic('article.pic')\"/>"+
					"</td></tr>";
				} else {
					pic = "<input name=\"article.pic\" type=\"hidden\" id=\"article.pic\" style=\"width:747px\" value=\""+ fieldValue +"\"/>";
				}
				sb.append(pic);
				
			} else if(fieldName.equals("media")) {
				if(isShowed) {
					media = "<tr><td class=\"td_left\">媒体：</td>" +
					"<td valign=\"middle\">	" +
					"<input name=\"article.media\" type=\"text\" class=\"input_text_normal\" id=\"media\" style=\"width:470px\" readOnly value=\""+ fieldValue +"\"/>"+
					"&nbsp;&nbsp;<input name=\"button\" type=\"button\" value=\"上传\" class=\"btn_small\"  onclick=\"uploadFlash('article.media')\"/>"+
					"&nbsp;&nbsp;<input name=\"button2\" type=\"button\" value=\"清空\" class=\"btn_small\" onclick=\"clearFlash('article.media')\"/>"+
					"</td></tr>";
				} else {
					media = "<input name=\"article.media\" type=\"hidden\" id=\"article.media\" style=\"width:747px\" value=\""+ fieldValue +"\"/>";
				}
				sb.append(media);
				
			} else if(fieldName.equals("attach")) {
				if(isShowed) {
					attach = "<tr><td class=\"td_left\">附件：</td>" +
					"<td valign=\"middle\">	" +
					"<input name=\"article.attach\" type=\"text\"  class=\"input_text_normal\" id=\"attach\" style=\"width:470px\" readOnly value=\""+ fieldValue +"\"/>"+
					"&nbsp;&nbsp;<input name=\"button\" type=\"button\" value=\"上传\" class=\"btn_small\"  onclick=\"uploadAtta('article.attach')\"/>"+
					"&nbsp;&nbsp;<input name=\"button2\" type=\"button\" value=\"清空\" class=\"btn_small\"  onclick=\"clearAtta('article.attach')\"/>"+
					"</td></tr>";
				} else {
					attach = "<input name=\"article.attach\" type=\"hidden\" id=\"attach\" style=\"width:747px\" value=\""+ fieldValue +"\"/>";
				}
				sb.append(attach);
			}
			...
			if(!attribute.getFieldName().equals("title") 
					...
					&& !attribute.getFieldName().equals("textArea")
					&& !attribute.getFieldName().equals("keyword")
					&& !attribute.getFieldName().equals("brief")
					&& !attribute.getFieldName().equals("pic")
					&& !attribute.getFieldName().equals("media")
					&& !attribute.getFieldName().equals("attach")
