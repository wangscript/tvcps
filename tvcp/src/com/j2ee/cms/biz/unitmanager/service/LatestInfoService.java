...
public interface LatestInfoService {
	...
	/**
	 * 保存生成的配置内容到数据库
	 * @param latestInfoForm 标题链接form对象
	 * @param filePath 配置文件路径
	 * @param siteId
	 * @param sessionID
	 */
	void saveConfigContent( LatestInfoForm latestInfoForm,String filePath, String siteId, String sessionID);
	 ...
	 * @return newfilepath
	 */
	String saveConfigXml( LatestInfoForm latestInfoForm);
	 ...
	 * @param siteId 网站ID
	 */
	void findConfig(LatestInfoForm latestInfoForm,String siteId);
